...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 20, fontWeight: '700', color: '#1C1C1E', textAlign: 'center', marginBottom: 2 },
  headerSubtitle: { fontSize: 12, color: '#8E8E93', textAlign: 'center', lineHeight: 16 },
  section: {
    marginBottom: 16,
    marginHorizontal: 24,
